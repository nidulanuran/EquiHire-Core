                ...
                <div className="w-[400px] flex flex-col space-y-4 animate-in slide-in-from-right-10 duration-300">
                    ...
                    <Card className="flex-1 shadow-lg border-gray-200 overflow-auto">
                        ...
                        <CardContent className="pt-6 space-y-6">
                            ...
                            {/* Candidate Context V2 */}
                            {selectedCandidate.experienceLevel && (
                                <div>
                                    <h4 className="text-sm font-bold text-gray-900 mb-2">Candidate Context</h4>
                                    <div className="bg-white border border-gray-200 p-3 rounded-lg shadow-sm space-y-3">
                                        ...
                                        {selectedCandidate.detectedStack?.length > 0 && (
                                            <div>
                                                <span className="text-[10px] text-gray-400 uppercase font-semibold mb-1 block">Detected Tech Stack</span>
                                                <div className="flex gap-1.5 flex-wrap">
                                                    {selectedCandidate.detectedStack.map((tech: string, i: number) => (
                                                        <span key={i} className="text-xs text-gray-600 bg-gray-100 border border-gray-200 px-2 py-0.5 rounded-sm font-medium">
                                                            {tech}
                                                        </span>
                                                    ))}
                                                </div>
                            ...
                            {/* HuggingFace Relevance Alert */}
                            {selectedCandidate.hfRelevanceSkipped > 0 && (
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-red-600 mt-0.5">
                                                {selectedCandidate.hfRelevanceSkipped} answer(s) failed the relevance check and were flagged as gibberish or AI-generated bypass attempts. They received an automatic score of 0.
                                            </p>
                                        </div>
                                    </div>
                                </div>
